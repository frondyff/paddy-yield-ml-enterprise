...
- `variety`: joint stability=100.0%, mean SHAP rank=3.3, mean permutation rank=1.0.
- `P_fertilizer`: joint stability=100.0%, mean SHAP rank=6.0, mean permutation rank=3.7.
- `flooded`: joint stability=100.0%, mean SHAP rank=8.3, mean permutation rank=3.0.
