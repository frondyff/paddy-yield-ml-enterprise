...
- `variety`: joint stability=100.0%, mean SHAP rank=3.0, mean permutation rank=1.0.
- `flooded`: joint stability=100.0%, mean SHAP rank=4.7, mean permutation rank=3.0.
- `P_fertilizer`: joint stability=100.0%, mean SHAP rank=7.0, mean permutation rank=3.7.
...
- `R5`: expected lift=+1674.2 kg/ha, support=10.0%, confidence=Medium (caveats: associative_only,requires_causal_validation).
...
- `R4`: expected lift=-1223.3 kg/ha, support=12.5%, confidence=High (caveats: associative_only,requires_causal_validation).
  Where it works: none | Conflicts: none | Insufficient evidence: Benin, Japan, Nigeria, Philippines | Unstable/small effect: Burkina Faso.
